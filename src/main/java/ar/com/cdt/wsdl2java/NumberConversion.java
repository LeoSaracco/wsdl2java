 ...
 * 2022-06-22T09:49:10.299-03:00
 * Generated source version: 3.4.2
 *
 */
@WebServiceClient(name = "NumberConversion",
                  wsdlLocation = "file:/home/leandro/Escritorio/UTN/Ejercicios/dataaccess/src/main/resources/wsdl/numberconversion.wsdl",
...
public class NumberConversion extends Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("file:/home/leandro/Escritorio/UTN/Ejercicios/dataaccess/src/main/resources/wsdl/numberconversion.wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(NumberConversion.class.getName())
                .log(java.util.logging.Level.INFO,
                     "Can not initialize the default wsdl from {0}", "file:/home/leandro/Escritorio/UTN/Ejercicios/dataaccess/src/main/resources/wsdl/numberconversion.wsdl");
        }
        WSDL_LOCATION = url;
    }
